...
\newcommand{\archStart}{\section{Architecture}\begin{multicols}{2}\footnotesize}
...
\newcommand{\gxs}[3]{\vcenteredinclude{#2}{\hspace{3mm} \begin{minipage}{\minipagespacing}{\bf \small{#1}}\\ \tt \seqsplit{#3}\end{minipage}}\vspace{\vspacing}\newline}


%\newcommand{\APIGatewayEndpoint}[1]{\includegraphics[width=#1]{Res_Amazon-API-Gateway_Endpoint_48_Light.pdf}\\ \texttt{{\textbackslash}APIGatewayEndpoint}}
...
Assets package used: \href{https://d1.awsstatic.com/webteam/architecture-icons/Q32020/AWS-Architecture-Assets-For-Light-and-Dark-BG_20200911.478ff05b80f909792f7853b1a28de8e28eac67f4.zip}{\seqsplit{AWS-Architecture-Assets-For-Light-and-Dark-BG\_20200911.478ff05b80f909792f7853b1a28de8e28eac67f4.zip}}
